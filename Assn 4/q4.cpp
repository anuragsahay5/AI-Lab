...
bool validState(state *S)
{
    ...
    if ((S->pos != 0) && (S->pos != 1))
        return false;
    if ((S->tl == 1 && S->gl == 1 && S->pos == 1))
        return false;
    if ((S->cl == 1 && S->gl == 1 && S->pos == 1))
        return false;
    if ((S->tr == 1 && S->gr == 1 && S->pos == 0))
        return false;
    if ((S->cr == 1 && S->gr == 1 && S->pos == 0))
        return false;
...
void printOP(int n)
{
    ...
    case 0:
        cout << "1,0,0 : from right to left" << endl;
        break;
    case 1:
        cout << "0,0,1 : from right to left" << endl;
        break;
    case 2:
        cout << "0,1,0 : from right to left" << endl;
        break;
    case 3:
        cout << "0,0,0 : from right to left" << endl;
        break;
    case 4:
        cout << "1,0,0 : from left to right" << endl;
        break;
    case 5:
        cout << "0,0,1 : from left to right" << endl;
        break;
    case 6:
        cout << "0,1,0 : from left to right" << endl;
        break;
    case 7:
        cout << "0,0,0 : from left to right" << endl;
        break;
    }
}
...
int main()
{
    ...
    {
        cout << "Path found!\n";
        cout << "tiger, goat, cabbage, boat posn\n";
